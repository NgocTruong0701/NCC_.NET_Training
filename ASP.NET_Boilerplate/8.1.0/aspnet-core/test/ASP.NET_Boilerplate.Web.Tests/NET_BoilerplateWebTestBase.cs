...
{
    public abstract class NET_BoilerplateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NET_BoilerplateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NET_BoilerplateWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NET_BoilerplateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NET_BoilerplateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NET_BoilerplateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NET_BoilerplateDbContext, Task<T>> func)
        {
            T result;
