...
namespace Ncc.Authorization
{
    ...
    public class SystemPermission
    {
        ...
        public static List<SystemPermission> ListPermissions = new List<SystemPermission>()
        {
            ...
            new SystemPermission{ Name =  PermissionNames.Admin_Configuration_SettingWorkerNoticeKomuPunishmentUserNoCheckInOut_Update, MultiTenancySides = MultiTenancySides.Host , DisplayName = "Update Punished Check In Configg" },
