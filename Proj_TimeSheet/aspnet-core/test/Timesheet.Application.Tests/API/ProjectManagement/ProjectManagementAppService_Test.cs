...
namespace Timesheet.Application.Tests.API.ProjectManagement
{
    ...
    public class ProjectManagementAppService_Test : TimesheetApplicationTestBase
    {
        ...
        public ProjectManagementAppService_Test()
        {
            ...
            var komuService = Substitute.For<KomuService>(httpClient, logger, configuration);
        ...
        public async void CreateProject()
        {
            ...
            var input = new SpecialProjectDto
            {
                ...
                EmailPM = "toai.nguyencong@ncc.asia"
            };
            await WithUnitOfWorkAsync(async () =>
            {
        ...
        public async void CreateProject_ExistingName()
        {
            ...
            {
                var result = await _project.CreateProject(input);
                Assert.Equal("Fail! Project name <b>Project Xolve</b> already exist in <b>TIMESHEET TOOL</b>", result);
            });
        }
        ...
        public async void CreateProject_ExistingCode()
        {
            ...
            {
                var result = await _project.CreateProject(input);
                Assert.Equal("Fail! Project code <b>Project Xolve</b> already exist in <b>TIMESHEET TOOL</b>", result);
            });
        }
        ...
        //        EmailAddress = "hieu.trantrung@ncc.asia",
        //        PMEmail = "toai.nguyencong@ncc.asia",
        //        Role = 1,
        //        IsPool = false,
...
/*        [Fact]
        ...
        public async void CreateCustomer_ExistingName()
        {
            ...
            {
                var result = await _project.CreateCustomer(input);
                Assert.Equal("<p style='color:#dc3545'>Fail! Customer name <b>Trudi</b> already exist in <b>TIMESHEET TOOL</b></p>", result);
            });
        }
        ...
        public async void GetRetroReviewInternHistories()
        {
            ...
            {
                Emails = new List<string> { "linh.nguyenthuy@ncc.asia", "trang.vuquynh@ncc.asia" },
                MaxCountHistory = 10
            };
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                Assert.Equal("linh.nguyenthuy@ncc.asia", result[0].Email);
                Assert.Equal(2, result[1].PointHistories.Count);
                Assert.Equal("trang.vuquynh@ncc.asia", result[1].Email);
            });
        }
    }
}
