    ...
    public class RequestDayAppServiceTest : RequestDayAppServiceTestBase
    {
        ...
        public async void GetAllRequest()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.ShouldContain(request => request.AbsenceTime == OnDayType.DiMuon);
                result.ShouldContain(request => request.BranchDisplayName == expectedBranchName);
                result.ShouldContain(request => request.DateType == DayType.Custom);
        ...
        public async void GetAllMyRequest()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                var result = await _requestDayAppService.GetAllMyRequest(startDate, endDate, requestType);
