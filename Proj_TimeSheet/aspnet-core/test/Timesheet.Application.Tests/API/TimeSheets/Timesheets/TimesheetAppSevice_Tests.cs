    ...
    public class TimesheetAppSevice_Tests : TimesheetApplicationTestBase
    {
        ...
        public async Task Should_Get_All_With_Filter_Have_Checkin()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result[1].CustomerName.ShouldBe("Xolve");
                result[1].DateAt.ShouldBe(new DateTime(2022, 12, 26));
                result[1].EmailAddress.ShouldBe("duong.tranduc@ncc.asia");
                result[1].ProjectCode.ShouldBe("Project Xolve");
                result[1].ProjectId.ShouldBe(5);
                result[1].ProjectName.ShouldBe("Project Xolve");
                ...
                result[1].User.ShouldBe("Dương Trần Đức");
        ...
        public async Task Should_Get_Timesheet_Warning()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                Assert.Equal(3, result.Count);
                result.First().DateAt.ShouldBe(new DateTime(2022, 12, 18));
                result.First().EmailAddress.ShouldBe("linh.nguyenthuy@ncc.asia");
                result.First().HourOff.ShouldBe(0);
                result.First().Id.ShouldBe(114);
                ...
                result.First().UserId.ShouldBe(9);
        ...
        public async Task Should_Get_All_Timesheet_Or_Remote_With_Export_True()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.First().Name.ShouldBe("Trang");
                result.First().ProjectName.ShouldBe("Project Xolve");
        ...
        public async Task Should_Get_All_Timesheet_Or_Remote_With_Export_False()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.First().Name.ShouldBe("Hiếu Trần Trung");
        ...
        public async Task Should_Get_Quantity_Timesheet_Status_With_Filter_Null()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                var result = await _timesheet.GetQuantiyTimesheetStatus(inputStartDate, inputEndDate, inputProjectId, inputFilter);
